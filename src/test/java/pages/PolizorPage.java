...
import static utils.BrowserUtils.scrollIntoView;
...
//    private By addToWishlistButton = By.cssSelector("[class='action towishlist']");
...
//        waitUntilElementIsVisible(driver.findElement(productList));
