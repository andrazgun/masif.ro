...
public class HomePage extends BasePage {
    ...
    private String loginIcon = "[class='my-account']";
    private String wishlistIcon = "[class='my-wishlist']";
    private String productsNavigationSelector = "nav-trigger";
    ...
    private String electricToolsSelector = "#html-body > div.page-wrapper > header > div.page-navigation > div > div > div.col-xs-12.col-sm-3.col-md-3.col-lg-2.left-navigation > nav > ul > li.main-menu__item.main-menu__item--parent.scule-electrice.column3.image.parent--level0 > a";
